  ...
  return (
    ...
    >
      ...
      <p className="text-base text-gray-700 mb-4">
        ...
        technologies, I enjoy crafting intuitive user interfaces while ensuring
        robust, secure backend systems. I thrive on solving complex challenges
        and translating product ideas into seamless digital solutions.
      </p>
      <p className="text-base text-gray-700 mb-4">
        ...
        strong understanding of performance optimization, responsive design, and
        user-centric features. I believe in using technology to create
      ...
      <p className="text-base text-gray-700 mb-4">
        ...
        performance, I was able to deliver a product that significantly reduced
        reliance on external services and increased operational accuracy.
      </p>
